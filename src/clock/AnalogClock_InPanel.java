    ...
    public void actionPerformed(java.awt.event.ActionEvent event)
    {
        ...
        {   
            ...
            {                
                ...
                {
                    ((ClockPanelWeather) getParent()).dayLabel.setText("tomorrow");
                }
                else if (java.util.Calendar.getInstance().get(java.util.Calendar.HOUR_OF_DAY) - this.timeZoneOffsetHour < 0)
                {
                    ((ClockPanelWeather) getParent()).dayLabel.setText("yesterday");
                }
                else
                {
                    ((ClockPanelWeather) getParent()).dayLabel.setText("today");
                }
            }
            repaint(0, 0, getWidth(), getHeight());
        }
